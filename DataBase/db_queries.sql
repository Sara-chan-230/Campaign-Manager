...
'A dedicated non-profit organization focused on providing immediate and long-term aid to communities affected by earthquakes across Morocco. Our mission is to ensure that no victim is left behind in the aftermath of a natural disaster. We work tirelessly to offer humanitarian aid such as food, shelter, medical supplies, and psychological support to those who have lost their homes and loved ones. We also focus on rebuilding efforts, providing infrastructure repair, and promoting disaster resilience in vulnerable areas. Our team of volunteers, together with local authorities and international partners, ensures that our relief efforts are both swift and effective, reaching every corner of Morocco affected by seismic activity.', 
...
(1, 'Temporary Shelters for Displaced Families', 'Temporary shelters are being set up for families who lost their homes, offering them a safe place to stay while more permanent solutions are planned. The project is currently in the planning phase.', '2025-05-01', 300000.00, 120000.00, 'Planning', NULL),
(1, 'Rehabilitation of Damaged Infrastructure', 'This project focuses on repairing roads, bridges, and critical infrastructure. The goal is to restore essential services and help communities get back to normal. The rehabilitation efforts are set to begin soon.', '2025-06-01', 1500000.00, 500000.00, 'Not started', NULL),
(1, 'Earthquake Awareness Campaign', 'The campaign aims to raise awareness about earthquake preparedness, teaching communities how to protect themselves in case of future earthquakes. It is currently active and ongoing.', '2025-07-01', 100000.00, 25000.00, 'Ongoing', NULL),
...
(1, 'Restoring Local Schools and Hospitals', 'This initiative focuses on repairing schools and hospitals, vital institutions that support both education and healthcare. The restoration work has been completed, and these facilities are now operational again.', '2025-09-01', 600000.00, 200000.00, 'Completed', NULL),
(1, 'Rebuilding Earthquake-hit Villages', 'This project focuses on rebuilding entire villages that were devastated by the earthquake. It includes restoring homes and community buildings. The planning stage is underway, with construction set to begin soon.', '2025-10-01', 800000.00, 300000.00, 'Planning', NULL);
...
('Organize a fundraiser to support ocean conservation projects.', '2025-03-10', '#87CEEB', 4),
('Collaborate with local authorities to prevent illegal fishing in protected areas.', '2025-03-12', '#A9A9A9', 4),
